...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='./models/1022_baseline_5/deeplab-100.pth') 
    parser.add_argument('--train_path', type=str, default='./dataset/1-2400/train/')  
    ...
    '2.1 generate_pseudo:'
    parser.add_argument('--pseudo_file', type=str, default='./generate_pseudo/')  
    '2.2 sim_learn:'
    parser.add_argument('--sim_learn_num_epochs', type=int, default=10)
    parser.add_argument('--sim_learn_batch_size', type=int, default=8)
    parser.add_argument('--radius', type=int, default=6, help='radius')  
    '2.3 pl_refine:'
