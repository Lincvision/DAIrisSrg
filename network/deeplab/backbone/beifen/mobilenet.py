...
import math
from network.deeplab_a.sync_batchnorm.batchnorm import SynchronizedBatchNorm2d
import torch.utils.model_zoo as model_zoo
from network.deeplab_a.dropblock import DropBlock2D
...
class MobileNetV2(nn.Module):
    ...
    def forward(self, x):
        ...
        # low_level_feat = self.dropblock(low_level_feat)
